...
* 4🥈 Our Manipulation Mask Generator(PRML 2023 by Yang, et.al) can generate high quality datasets in python, with code embedded. [Manipulation-Mask-Generator](https://github.com/ndyysheep/MTVNR)
